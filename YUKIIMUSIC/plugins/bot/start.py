...
async def start_pm(client, message: Message, _):
    ...
    try:
        stk = await message.reply_sticker("CAACAgUAAxkBAAFJa1ZqAwWA5oQWfD3ZEr5MTvNofuUAAYoAAislAALub4hXaV1eM-iaeoY7BA")
    ...
    await asyncio.sleep(0.4)
    await loading_1.edit_text("<emoji id='5413840936994097463'>🌺</emoji> <b>˹ᴀᴋᴀꜱʜ ʙᴏᴛs˼\nsᴛᴧʀᴛed!</b>")
